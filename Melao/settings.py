...
STATIC_ROOT = os.path.join(BASE_DIR, 'static/sd')
STATICFILES_DIRS = [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'melaoaplicacion@gmail.com'
EMAIL_HOST_PASSWORD = 'kxhx wjjb pofj ngfy' #esta es el password de aplicacion generado por Gmail